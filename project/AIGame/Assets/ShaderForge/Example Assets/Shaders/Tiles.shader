...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:3,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:0,x:33683,y:32856,varname:node_0,prsc:2|diff-3580-OUT,spec-145-OUT,gloss-146-OUT,normal-123-RGB,amspl-162-OUT;n:type:ShaderForge.SFN_Tex2d,id:123,x:33091,y:33131,ptovrint:False,ptlb:Normal,ptin:_Normal,varname:_Normal,prsc:2,tex:bbab0a6f7bae9cf42bf057d8ee2755f6,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:138,x:32667,y:32659,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:_Diffuse,prsc:2,tex:b66bceaf0cc0ace4e9bdc92f14bba709,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:144,x:32384,y:33104,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:_Gloss,prsc:2,min:0,cur:0.4900382,max:1;n:type:ShaderForge.SFN_Slider,id:145,x:33010,y:32820,ptovrint:False,ptlb:Specular,ptin:_Specular,varname:_Specular,prsc:2,min:0,cur:0.1837857,max:1;n:type:ShaderForge.SFN_Multiply,id:146,x:33220,y:32957,varname:node_146,prsc:2|A-147-OUT,B-144-OUT;n:type:ShaderForge.SFN_Power,id:147,x:32921,y:32882,varname:node_147,prsc:2|VAL-138-R,EXP-148-OUT;n:type:ShaderForge.SFN_Vector1,id:148,x:32703,y:32916,varname:node_148,prsc:2,v1:2;n:type:ShaderForge.SFN_Cubemap,id:156,x:32993,y:33373,ptovrint:False,ptlb:Specular IBL,ptin:_SpecularIBL,varname:_SpecularIBL,prsc:2,cube:f466cf7415226e046b096197eb7341aa,pvfc:0|MIP-176-OUT;n:type:ShaderForge.SFN_Multiply,id:162,x:33183,y:33373,cmnt:RGBM Decode,varname:node_162,prsc:2|A-156-RGB,B-156-A,C-163-OUT;n:type:ShaderForge.SFN_Vector1,id:163,x:32993,y:33527,varname:node_163,prsc:2,v1:4;n:type:ShaderForge.SFN_RemapRange,id:176,x:32815,y:33373,varname:node_176,prsc:2,frmn:0,frmx:1,tomn:6,tomx:0|IN-144-OUT;n:type:ShaderForge.SFN_OneMinus,id:9122,x:33337,y:32766,varname:node_9122,prsc:2|IN-145-OUT;n:type:ShaderForge.SFN_Multiply,id:3580,x:33178,y:32652,varname:node_3580,prsc:2|A-138-R,B-9122-OUT;proporder:123-138-144-145-156;pass:END;sub:END;*/

Shader "Shader Forge/Examples/Tiles" {
    Properties {
        _Normal ("Normal", 2D) = "bump" {}
        _Diffuse ("Diffuse", 2D) = "white" {}
        _Gloss ("Gloss", Range(0, 1)) = 0.4900382
        _Specular ("Specular", Range(0, 1)) = 0.1837857
