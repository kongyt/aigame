...
public class CavalryBehaviour : MonoBehaviour {
    ...
    private HorseType lastHorseType;
    ...
    [Space(20)]
    public Material horseA;
    public Material horseB;
    public Material horseC;
    public Material horseD;
    ...
    public void SetHorseType(HorseType type) {
        ...
        { 
            case HorseType.A:
                horse.material = horseA;
                break;
            case HorseType.B:
                horse.material = horseB;
                break;
            case HorseType.C:
                horse.material = horseC;
                break;
            case HorseType.D:
                horse.material = horseD;
                break;
        }
    }
